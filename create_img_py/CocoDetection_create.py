...
trainset = torchvision.datasets.Caltech256(root='./Caltech256/',    #데이터 경로
                          transform=transforms.ToTensor(),
                          download=True)
trainloader = torch.utils.data.Caltech256(trainset, batch_size=1,
                                          shuffle=False, num_workers=2)

testset = torchvision.datasets.Caltech256(root='./Caltech256/',
                         transform=transforms.ToTensor(),
                         download=True)
