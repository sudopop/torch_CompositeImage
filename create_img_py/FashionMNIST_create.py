...
trainset = torchvision.datasets.FashionMNIST(root='./FashionMNIST/',    #데이터 경로
                          train=True,            #train 데이터로 가져올건지 False면 test data
...
testset = torchvision.datasets.FashionMNIST(root='./FashionMNIST/',
                         train=False,
                         transform=transforms.ToTensor(),
                         download=True)
