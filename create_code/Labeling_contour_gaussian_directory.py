...
class Composite():
    ...
    def getitem(self, idx, bg_true=False):
        ...
        for cnt in contours:
            cv2.drawContours(normal_gray_label, [cnt], 0, (0, 0, 0), 0)
        ...
        # cv2.imshow('ano_gray', normal_gray_label)
        # cv2.imshow('normal_gray_img', normal_gray_img)
...
def main():
    ...
    dir_name = []
    dir_name += [each for each in os.listdir("/home/son/Work/Pytorch-UNet/create_dataset/food_dataset/images/")]
    iid = 0
    for iidx in range(len(dir_name)):
        Anomaly_path = "/home/son/Work/Pytorch-UNet/create_dataset/food_dataset/images/"
        dataset_name = dir_name[iidx]
        Anomaly_path = Anomaly_path + dataset_name
        img_save_path = "./train_imgsamll/"
        # img_save_path = img_save_path + dataset_name + "_train"
        label_save_path = "./label_labelbig/"
